  ...
  return Alpine.data("content", function() {
    return {
      ...
      setLazyLoadToImages: function setLazyLoadToImages() {
        this.$article
          .querySelectorAll("figure[class^=image] img")
          .forEach(this.setLazyLoadToImage);
      },
      /**
      ...
      setRatioToImages: function setRatioToImages() {
        this.$article
          .querySelectorAll("figure.imageslideblock")
          .forEach(this.setRatioToImageSlideBlock.bind(this));
        this.$article
          .querySelectorAll("figure.imageblock")
          .forEach(this.setRatioToImageBlock.bind(this));
        this.$article
          .querySelectorAll("figure.imagegridblock")
          .forEach(this.setRatioToImageGridBlock.bind(this));
      },
      /**
       ...
       * @param {HTMLElement} $imageBlock
       */
      setRatioToImageSlideBlock: function setRatioToImageSlideBlock(
        $imageBlock,
      ) {
      ...
      setPositionToImages: function setPositionToImages() {
        this.$article
          .querySelectorAll("figure.imageblock")
          .forEach(this.setImageBlockPosition.bind(this));
        this.$article
          .querySelectorAll("figure.imagegridblock")
          .forEach(this.setImageGridBlockPosition.bind(this));
      },
      /**
       ...
       * @param {HTMLElement} $imageBlock
       */
      setImageGridBlockPosition: function setImageGridBlockPosition(
        $imageBlock,
      ) {
      ...
      imageBlockWidth: function imageBlockWidth($imageBlock) {
        ...
        var $image = $imageWrap.querySelector("img");
        var width =
          $image.getAttribute("width") || $imageBlock.dataset.originWidth;
...
document.addEventListener("alpine:init", function() {
  return Alpine.data("theme", function() {
    return {
       ...
       */
      toggle: function toggle() {
        localStorage.TTDARK = document.documentElement.classList.contains(
          "dark",
        )
          ? "N"
          : "Y";
